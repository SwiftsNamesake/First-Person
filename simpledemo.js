...
function attachListeners(context, scene) {
	...
	for (var model of ['king.obj', 'villa.obj', 'OBJTest2.obj', 'minecraft1.obj']) {
		(function(model) {
...
function createScene(context) {
	...
	scene.push(new Entity({ mass: 1.0, velocity: [0,0,0], acceleration: [0,0,0], angular: [0,2,0], position: light, rotation: [0,0,0], mesh: new Mesh(shapes.sphere(0.05)) }));
